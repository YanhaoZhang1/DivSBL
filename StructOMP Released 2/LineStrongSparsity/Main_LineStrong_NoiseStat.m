...
for j=1:length(noise_num),
    fprintf('j==%d\n', j);
%     m=m_num(j)
for iter=1:5, %%% adjust, how many time do you want to run experiments
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
errorbar(noise_num, CompareResults(6,:), CompareResultsStd(6,:), 'yh-', 'linewidth', 3,  'MarkerSize',ms); 
...
axis([noise_num(1)-0.01 noise_num(end)+0.01 -0.1 1.6])
