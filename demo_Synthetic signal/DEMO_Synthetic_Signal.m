...
stem(Result_DV.x(:,Result_DV.count), 'LineWidth', 1.7, 'Marker', 'none', 'Color', '#0072BD'); % 使用RGB颜色值表示蓝�?
...
stem(Result1.x(:,Result1.count), 'LineWidth', 1.7, 'Marker', 'none', 'Color', '#0072BD'); % 使用RGB颜色值表示蓝�?
...
stem(x_new, 'LineWidth', 1.7, 'Marker', 'none', 'Color', '#0072BD'); % 使用RGB颜色值表示蓝�?
xlim([min(x_new), N]);
...
stem(x_BCS, 'LineWidth', 1.7, 'Marker', 'none', 'Color', '#0072BD'); % 使用RGB颜色值表示蓝�?
xlim([min(x_BCS), N]);
%% %Group Lasso
figure(6);

stem(x_group_lasso, 'LineWidth', 1.7, 'Marker', 'none', 'Color', '#0072BD'); % 使用RGB颜色值表示蓝�?
...
stem(x_GBPDN, 'LineWidth', 1.7, 'Marker', 'none', 'Color', '#0072BD'); % 使用RGB颜色值表示蓝�?
xlim([min(x_GBPDN), N]);
...
stem(x_StrOMP, 'LineWidth', 1.7, 'Marker', 'none', 'Color', '#0072BD'); % 使用RGB颜色值表示蓝�?
xlim([min(x_StrOMP), N]);
